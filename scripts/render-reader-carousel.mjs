...
async function slideNumbers() {
  ...
  s += lsp.txt({ text: "XOCHYL PEREZ AND EFREN RAMÍREZ · 2026 YOGA TEACHER TRAINING CLASS", x: M, y: 580, size: 14, color: R.ink, weight: 800, tracking: 2, family: SANS, opacity: 0.7 });
