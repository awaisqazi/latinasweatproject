...
**Hero (`#save-the-date`) → Impact band (`#impact`) → Evening with purpose (MCA venue) → Last year recap (light intermission, with 2025 sponsor gratitude marquee) → Closing invitation (`#gala-interest`).** The impact band sits high so the fundraising case lands before the venue and recap. Animated gold ribbon dividers separate the major dark sections, and a sticky interest-list bar follows the reader through the middle of the page.
