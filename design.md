...
- The printed flyer's "949 W 19th St" was confirmed to be a typo: the venue is the LSP Studio, 949 W **16th** St. The site renders the corrected address everywhere; only the flyer scans (`public/images/hausoflsp1.jpg` / `hausoflsp2.jpg`, converted from the supplied PNGs to 1000px JPEGs per the pride-spotlight precedent) still show 19th.
