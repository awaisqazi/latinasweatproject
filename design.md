...
graph TD
    ...
    Sec2 --> Sec3["Section 3: WGN9 Spotlight (bg-off-black)"]
...
- Current desktop media rhythm (left/right/left/right/left/right, Sep 2026): gala atrium photo on the left, WGN9 video on the right, Monday Miles tee on the left, 40 Under 40 flyer on the right, Monday Miles visual on the left, and the Studio / Grand Opening image on the right. (The recap band, the events carousel, Instagram, and Press are card grids or feeds, not media spotlights, so they do not affect the zig-zag.)
