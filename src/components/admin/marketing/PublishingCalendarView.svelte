  ...
  <div class="flex flex-col gap-3 rounded-lg border border-black/10 bg-white p-4 shadow-sm md:flex-row md:items-center md:justify-between md:p-5">
    ...
    <div class="flex flex-wrap items-center gap-2">
      ...
      <button
        ...
        onclick={loadPublishingProjects}
        disabled={isLoading}
      >
  ...
  <div class="rounded-lg border border-black/10 bg-white shadow-sm">
    <div class="flex flex-col gap-2 border-b border-black/10 px-4 py-4 md:flex-row md:items-end md:justify-between md:px-5">
      ...
      <div class="flex flex-wrap gap-2 text-xs font-bold">
        <span class="inline-flex items-center gap-1.5 rounded-full bg-amber-50 px-2.5 py-1 text-amber-800">
          <span class="h-2 w-2 rounded-full bg-amber-500"></span>
          Planned
        </span>
        <span class="inline-flex items-center gap-1.5 rounded-full bg-emerald-50 px-2.5 py-1 text-emerald-800">
            ...
            >
              ...
              <div class="space-y-1.5">
                {#each day.projects as project}
                  <button
                    type="button"
                    class="group w-full rounded-md border px-2 py-1.5 text-left text-xs font-semibold leading-snug transition focus:outline-none focus:ring-2 focus:ring-[#0f766e] focus:ring-offset-1 {getEventClass(project)}"
