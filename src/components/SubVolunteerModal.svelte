<script>
    ...
    function submit() {
        ...
        dispatch("submit", { name, email, phone, request });
    }
        ...
        >
            {#if success}
                ...
                <div class="p-6 space-y-6">
                    ...
                    >
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="font-medium text-gray-900">
                                    {formatTime(request.date, request.duration)}
                                </p>
                            </div>
                        </div>
                        <div class="flex items-start gap-3">
                        ...
                        <div class="pt-2 space-y-2">
                            ...
                            <button
                                ...
                                class="flex items-center justify-center gap-3 w-full px-4 py-3 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all font-medium text-gray-700 shadow-sm cursor-pointer"
                            >
                                <svg
                    ...
                    <button
                        on:click={close}
                        class="w-full px-4 py-2 text-gray-500 hover:text-gray-700 font-medium text-sm transition-colors cursor-pointer"
                    >
                        Close
                    </button>
                </div>
